...
{
	if (filearr->linkname != NULL && (filearr->permissions[0] == 'c' ||
	filearr->permissions[0] == 'b'))
		...
		filearr->time, filearr->filename, filearr->linkname);
	else if (filearr->linkname == NULL && (filearr->permissions[0] == 'c' ||
	filearr->permissions[0] == 'b'))
